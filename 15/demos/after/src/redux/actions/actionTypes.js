...
export const FILTER_AUTHOR_NAME_CHANGED = "FILTER_AUTHOR_NAME_CHANGED";

export const FILTER_TITLE_CHANGED = "FILTER_TITLE_CHANGED";
export const FILTER_AUTHOR_CHANGED = "FILTER_AUTHOR_CHANGED";
